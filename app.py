...
single_tab.write('')
single_tab.download_button('Download JSON',json.dumps(single_json,indent=4), file_name="export.json")
...
album_tab.write('')
album_tab.download_button('Download JSON',json.dumps(album_json,indent=4), file_name="export.json")
...
compilation_tab.download_button('Download JSON',json.dumps(compilation_json,indent=4), file_name="export.json")
...
hiphop_tab.write('')
hiphop_tab.download_button('Download JSON',json.dumps(hiphop_json,indent=4), file_name="export.json")
...
dance_tab.write('')
dance_tab.download_button('Download JSON',json.dumps(dance_json,indent=4), file_name="export.json")